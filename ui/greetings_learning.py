...
class GreetingsLearning(QWidget):
    ...
    def init_ui(self):
        ...
        grid_layout.setContentsMargins(20, 20, 20, 20)  # Reduced from 30,30,30,30
    ...
    def create_phrase_button(self, phrase, is_long=False):
        ...
        button.setFixedHeight(120)  # Reduced from 150
        
        # Set consistent widths
        if is_long:
            button.setFixedWidth(220)  # Reduced from 300
        else:
            button.setFixedWidth(220)  # Reduced from 300
