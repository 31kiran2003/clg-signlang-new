...
class BeginnerMode(QWidget):
    ...
    def init_ui(self):
       ...
       # Skip Button
        ...
        self.skip_button.setFixedWidth(450)
    ...
    def show_completion_screen(self):
        ...
        completion_container.setFixedWidth(400)
        ...
        # Trophy icon
        trophy_label = QLabel("🏆")
        trophy_label.setStyleSheet("font-size: 28px; margin-bottom: 4px;")
        ...
        if self.stats['correct_answers'] > 0:
            ...
            correct_label.setStyleSheet("font-size: 12px; font-weight: bold; color: #196f3d;")
            ...
            accuracy_label.setStyleSheet("font-size: 12px; font-weight: bold; color: #7d3c98;")
            ...
            avg_time_label.setStyleSheet("font-size: 12px; font-weight: bold; color: #1a5276;")
            ...
            best_time_label.setStyleSheet("font-size: 12px; font-weight: bold; color: #a93226;")
            ...
            stats_label.setStyleSheet("font-size: 14px; color: #c0392b; font-weight: bold;")
        ...
        anim.setDuration(700)  # Reduced from 800
        anim.setStartValue(completion_container.pos() + QPoint(0, 25))  # Reduced from 30
    ...
    def show_success_emoji(self):
        ...
        success_label.setFixedSize(80, 80)  # Reduced from 100x100
    ...
    def show_wrong_emoji(self):
        ...
        wrong_label.setFixedSize(80, 80)  # Reduced from 100x100
    ...
    def show_hint(self):
        if self.practice_mode:
            ...
            hint_label.move(
                ...
                self.height() - hint_label.height() - 15
            )
            hint_label.show()
    ...
    def show_level_transition(self, level):
        ...
        QTimer.singleShot(1800, level_label.deleteLater)  # Reduced from 2000
    ...
    def show_emoji_animation(self, emoji_label):
        ...
        anim.setDuration(800)  # Reduced from 1000
        anim.setStartValue(emoji_label.pos())
        
        # Calculate the new position using QPoint arithmetic
        new_pos = emoji_label.pos() + QPoint(0, -20)  # Reduced from -30
        ...
        QTimer.singleShot(800, emoji_label.deleteLater)  # Reduced from 1000
    ...
    def show_exit_confirmation(self):
        ...
        """)
        dialog.setFixedWidth(300)  # Reduced from larger size
