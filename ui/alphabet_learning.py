...
class AlphabetLearning(QWidget):
    ...
    def init_ui(self):
        ...
        main_layout.setContentsMargins(30, 20, 30, 30)  # Reduced top margin
        main_layout.setSpacing(20)  # Reduced spacing

        # Header section with reduced height
        header_frame = QFrame()
        header_frame.setFixedHeight(120)  # Set a fixed reduced height
    ...
    """)
        ...
        back_button.setIconSize(QSize(18, 18))  # Reduced from 32x32
    ...
    """)
        ...
        # Reduced header label font size
    ...
    """)
        ...
        # Name input section with card style - slightly reduced
        input_frame = QFrame()
    ...
    """)
        ...
        learn_button.setIconSize(QSize(16, 16))  # Reduced from 20x20
    ...
    """)
        ...
        # Alphabet grid in a card - FURTHER reduced button size
        grid_frame = QFrame()
    ...
    """)
        ...
        grid_layout.setSpacing(8)  # Further reduced from 10
        
        # Create a 7x4 grid layout for better spacing with smaller buttons
        alphabets = [chr(i) for i in range(65, 91)]
        for i, letter in enumerate(alphabets):
            button = QPushButton(letter)
            button.setFixedSize(45, 45)  # Further reduced from 60x60
            ...
            # Use a 7x4 grid layout (7 columns, 4 rows)
            grid_layout.addWidget(button, i // 7, i % 7)
