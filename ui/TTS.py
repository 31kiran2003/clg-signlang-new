...
class TTS(QMainWindow):
    def __init__(self):
        ...
        self.video_widget.setMinimumSize(400, 300)  # Reduced from 450x350
        self.video_widget.setStyleSheet("""
            background-color: white;
            border-radius: 10px;  /* Reduced from 12px */
            border: 1px solid #eef2f7;  /* Reduced from 2px */
        """)
        ...
        self.setMinimumSize(900, 600)  # Reduced from 1091x672
        self.setFont(QFont("Segoe UI", 12))  # Reduced from 15
        self.setStyleSheet(f"background-color: {self.colors['secondary']};")
        
        # Define all styles with reduced sizes
        self.text_input_style = f"""
            QTextEdit {{
                border: 1px solid {self.colors['border']};  /* Reduced from 2px */
            ...
            QTextEdit:focus {{
                border: 1px solid {self.colors['primary']};  /* Reduced from 2px */
            }}
        """
    ...
    def create_main_content(self):
        ...
        main_layout.setSpacing(30)  # Reduced from 40
        main_layout.setContentsMargins(30, 30, 30, 30)  # Reduced from 50, 50, 50, 50
        ...
        shadow.setColor(QColor(0, 0, 0, 25))  # Reduced opacity from 30
        shadow.setOffset(0, 3)  # Reduced from 4
        left_frame.setGraphicsEffect(shadow)
        
        left_layout = QVBoxLayout(left_frame)
        left_layout.setContentsMargins(20, 20, 20, 20)  # Reduced from 30, 30, 30, 30
        left_layout.setSpacing(20)  # Reduced from 25
        ...
        self.text_input.setStyleSheet("""
            ...
            QTextEdit:focus {
                border: 1px solid #2962ff;  /* Reduced from 2px */
                background-color: white;
            }
        """)
        self.text_input.setMinimumHeight(160)  # Reduced from 200
        ...
        shadow2.setBlurRadius(15)  # Reduced from 20
        shadow2.setColor(QColor(0, 0, 0, 25))  # Reduced opacity from 30
        shadow2.setOffset(0, 3)  # Reduced from 4
        right_frame.setGraphicsEffect(shadow2)
        
        right_layout = QVBoxLayout(right_frame)
        right_layout.setContentsMargins(20, 20, 20, 20)  # Reduced from 30, 30, 30, 30
        right_layout.setSpacing(15)  # Reduced from 20
        ...
        video_label.setStyleSheet("""
            ...
            border-bottom: 1px solid #eef2f7;  /* Reduced from 2px */
            background-color: #ffffff;
        """)
        
        # Video Controls
        video_controls = QHBoxLayout()
        video_controls.setSpacing(10)  # Reduced from 15
        video_controls.setContentsMargins(0, 0, 0, 10)  # Reduced from 0, 0, 0, 15
        ...
        self.video_widget = QVideoWidget()
        self.video_widget.setMinimumSize(400, 300)  # Reduced from 450, 350
        self.video_widget.setStyleSheet("""
            background-color: #ffffff;
            border-radius: 10px;  /* Reduced from 12px */
            border: 1px solid #eef2f7;  /* Reduced from 2px */
        ...
        speed_control_layout.setSpacing(15)  # Reduced from 20
        speed_control_layout.setContentsMargins(0, 10, 0, 10)  # Reduced from 0, 15, 0, 15
        ...
        slider_layout.setContentsMargins(10, 3, 10, 3)  # Reduced from 15, 5, 15, 5
        slider_layout.setSpacing(10)  # Reduced from 15
        ...
        self.speed_slider.setMaximum(200)
        self.speed_slider.setValue(100)
        self.speed_slider.setFixedWidth(200)  # Reduced from 250
        ...
        self.speed_label.setStyleSheet("""
            QLabel {
                ...
                padding: 4px 10px;  /* Reduced from 5px 15px */
                background: #ffffff;
                border: 1px solid #2962ff;  /* Reduced from 2px */
                border-radius: 6px;  /* Reduced from 8px */
                text-align: center;
        ...
        button_style = """
            QPushButton {
                ...
                padding-right: 12px;  /* Reduced from 15px */
            }
            QPushButton:hover {
                background-color: #1e88e5;
                margin-top: -1px;
    ...
    def show_error(self, message: str):
        ...
        ok_button.setStyleSheet("""
            QPushButton {
                ...
                color: white;
                border: none;
                border-radius: 4px;  /* Reduced from original */
                font-size: 12px;  /* Reduced from original */
                padding: 5px 10px;  /* Reduced from original */
            }
            QPushButton:hover {
                background-color: #1e88e5;
            }
